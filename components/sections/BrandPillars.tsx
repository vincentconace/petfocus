        ...
        <div className="grid md:grid-cols-3 gap-6">
          {pillars.map((p, i) => (
            <motion.div
              ...
              className="group bg-bg-surface hover:bg-bg-subtle/70 rounded-3xl p-8 border border-line transition-[transform,box-shadow,background-color] duration-200 hover:-translate-y-1 hover:shadow-float-lg shadow-card"
            >
              <div
