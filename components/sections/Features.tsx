      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="display-2 mt-5">
            ...
            <span className="brand-accent-text">{t(T.features.italicWord, lang)}</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
          {T.features.items.map((item, i) => (
            ...
            >
              ...
              <div className="w-12 h-12 rounded-full bg-bg-subtle text-brand-primary flex items-center justify-center mb-5 border border-line/70 shadow-pill">
                {ICONS[i]}
              </div>
              <h3 className="font-display font-extrabold text-xl text-ink-primary mb-2 leading-tight">
                {t(item.title, lang)}
              </h3>
